...
abstract class BaseClient
{
    ...
    public function embedData(string $data): \App\Services\LlmServices\Responses\EmbeddingsResponseDto
    {
        Log::info('LlmDriver::MockClient::embedData');

        $data = get_fixture('embedding_response.json');

        return \App\Services\LlmServices\Responses\EmbeddingsResponseDto::from([
